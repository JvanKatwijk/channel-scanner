...
void	tiiDetector::addBuffer (std::vector<std::complex<float>> v,
...
void	tiiDetector::collapse (std::complex<float> *inVec, float *outVec) {
int	i;
...
#define	NUM_GROUPS	8
#define	GROUPSIZE	24
void	tiiDetector::processNULL (int16_t *mainId, int16_t *subId) {
int i, j;
...
void	tiiDetector::processNULL_ex (int	*pNumOut,
	                              int	*outTii,
	                              float	*outAvgSNR,
	                              float	*outMinSNR,
	                              float	*outNxtSNR) {
